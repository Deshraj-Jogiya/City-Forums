                            ...
                            <tr>
                                ...
                                <td style="height: 50px;">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if ($role->add_classified_ad == 1): ?>
                                            <label class="label label-default">Add New Ads</label>
                                        <?php endif; ?>
                                        <?php if ($role->classified_categories == 1): ?>
                                            <label class="label label-default">Manage Classified Categories</label>
                                        <?php endif; ?>
