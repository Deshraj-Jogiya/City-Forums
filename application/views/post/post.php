...
<div id="wrapper">
    <div class="container">
        <div class="row">
            <!-- breadcrumb -->
            <div class="col-sm-12 page-breadcrumb sdgsdfgdfgdfgdfg">
                <ol class="breadcrumb">
            ...
            <?php echo $post->show_right_column;?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <?php if ($this->general_settings->facebook_comment_active == 1): ?>
                                                <div id="facebook_comments" class="tab-pane fade <?php echo ($this->general_settings->comment_system != 1) ? 'in active' : ''; ?>">
                                                    <div id="div_fb_comments" class="fb-comments" data-href="<?php echo current_url(); ?>" data-width="100%" data-numposts="5"
