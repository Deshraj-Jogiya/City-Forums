        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <ul class="top-menu top-menu-right">
                    <li>                                
                        <a href="<?php echo admin_url().'add-new-ad'; ?>" class="btn_open_login_modal btn_post_an_ad"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Place an ad</a>
                    </li>
                    <?php if (check_user_permission('add_post')): ?>
                        <li>
                            <a href="#" data-toggle="modal" data-target="#modal_add_post" class="btn_open_login_modal btn_post_an_ad"><?php echo trans("add_post"); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if ($this->auth_check): ?>
                        <li class="dropdown profile-dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="<?php echo generate_url('my-listings'); ?>">
                                        <i class="fa fa-map"></i>
                                        My Listings
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo generate_url('favourites'); ?>">
                                        <i class="fa fa-map-marker"></i>
                                        Favourite Ads
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo generate_url('inquiries'); ?>">
                    ...
                    <?php else: ?>
                        <?php if ($this->general_settings->registration_system == 1): ?>
                            <li class="top-li-auth">                                
                                <a href="#" data-toggle="modal" data-target="#modal-login" class="btn_open_login_modal btn_post_an_ad"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Place an ad</a>
                            </li>
                        <?php endif; ?>
                        <?php if ($this->general_settings->registration_system == 1): ?>
                            <li class="top-li-auth">
