...
<div class="row">
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open('adcat_controller/add_subcategory_post'); ?>
                            ...
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable_lang" role="grid"
                                ...
                                <?php foreach ($categories as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php                                            
                                            $category = get_adcategory($item->parent_id, $this->adcategories);
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>update-ad-subcategory/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('adcat_controller/delete_category_post','<?php echo $item->id; ?>','<?php echo trans("confirm_category"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
