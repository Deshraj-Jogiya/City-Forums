        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-1 col-sm-2 col-xs-2">
                            <input type="checkbox" name="add_classified_ad" value="1" id="role_add_classified_ad" class="square-purple" <?php echo ($role->add_classified_ad == 1) ? 'checked' : ''; ?>>
                        </div>
                        <div class="col-md-11 col-sm-10 col-xs-10">
                            <label for="role_add_classified_ad" class="control-label cursor-pointer"><?php echo 'Add New Ads'; ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-1 col-sm-2 col-xs-2">
                            <input type="checkbox" name="classified_categories" value="1" id="role_classified_categories" class="square-purple" <?php echo ($role->classified_categories == 1) ? 'checked' : ''; ?>>
                        </div>
                        <div class="col-md-11 col-sm-10 col-xs-10">
                            <label for="role_classified_categories" class="control-label cursor-pointer"><?php echo 'Manage Classified Categories'; ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
