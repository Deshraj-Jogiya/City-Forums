...
<div class="box">
    <div class="box-header with-border">
        ...
        <div class="right">
            <a href="<?php echo admin_url(); ?>add-new-ad" class="btn btn-success btn-add-new pull-right">
                    ...
                    <table class="table table-bordered table-striped" role="grid">
                        ...
                        <?php foreach ($posts as $item):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $categories = get_parent_category_tree($item->category_id, $this->adcategories);
                                    if (!empty($categories)):
                                ...
                                <td>
                                    <!-- form post options -->
                                    <?php echo form_open('ad_controller/post_options_post'); ?>
                                    <input type="hidden" name="id" value="<?php echo html_escape($item->id); ?>">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            <li>
                                                <a href="<?php echo admin_url(); ?>update-ad/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                            </li>
                                            <?php if (check_user_permission('manage_all_ads')): ?>
                                            ...
                                            <?php endif; ?>
                                            <li>
                                                <a href="javascript:void(0)" onclick="delete_item('ad_controller/delete_post','<?php echo $item->id; ?>','<?php echo trans("confirm_post"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
