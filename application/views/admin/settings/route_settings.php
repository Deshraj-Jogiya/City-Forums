        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="classified_readonly" value="classified_ad" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> readonly>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="classified" value="<?php echo $this->routes->classified_ad; ?>" maxlength="100" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="adcategory_readonly" value="adcategory" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> readonly>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="adcategory" value="<?php echo $this->routes->adcategory; ?>" maxlength="100" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="delete_account_readonly" value="delete-account" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> readonly>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="delete_account" value="<?php echo $this->routes->delete_account; ?>" maxlength="100" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="earnings_readonly" value="earnings" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> readonly>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="earnings" value="<?php echo $this->routes->earnings; ?>" maxlength="100" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="payouts_readonly" value="payouts" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> readonly>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="payouts" value="<?php echo $this->routes->payouts; ?>" maxlength="100" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="set_payout_account_readonly" value="set-payout-account" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> readonly>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="set_payout_account" value="<?php echo $this->routes->set_payout_account; ?>" maxlength="100" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                        </div>
                    </div>
                </div>
                <div class="row">
