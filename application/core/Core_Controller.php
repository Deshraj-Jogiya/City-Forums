...
class Home_Core_Controller extends Core_Controller
{
    public function __construct()
    {
        ...
        //adcategories
        $this->adcategories = get_cached_data('adcategories');
        if (empty($this->adcategories)) {
            $this->adcategories = $this->adcategory_model->get_adcategories();
            set_cache_data('adcategories', $this->adcategories);
        }
        ...
        //latest adcategory posts
        $this->latest_adcategory_posts = get_cached_data('latest_adcategory_posts');
        if (empty($this->latest_adcategory_posts)) {
            $this->latest_adcategory_posts = $this->classified_model->get_latest_category_posts($this->selected_lang->id);
            set_cache_data('latest_adcategory_posts', $this->latest_adcategory_posts);
        }
        //random posts
