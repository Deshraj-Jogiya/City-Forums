    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar sidebar-scrollbar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <?php endif; ?>
                <?php if (check_user_permission('add_classified_ad')): ?>                   
                    <li class="nav-classified-ad">
                        <a href="<?php echo admin_url(); ?>add-new-ad">
                            <i class="fa fa-map-marker"></i>
                            <span>Add New Ad</span>
                        </a>
                    </li>                     
                    <li class="treeview<?php is_admin_nav_active(['ads', 'ad-categories', 'ad-subcategories']); ?>">
                        <a href="#">
                            <i class="fa fa-map"></i> <span>Classified Ads</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="nav-posts">
                                <a href="<?php echo admin_url(); ?>ads">Ads</a>
                            </li>
                            <?php if (check_user_permission('classified_categories')): ?>
                                <li class="nav-classified-categories">
                                    <a href="<?php echo admin_url(); ?>ad-categories">Classified Categories</a>
                                </li>
                                <li class="nav-classified-subcategories">
                                    <a href="<?php echo admin_url(); ?>ad-subcategories">Classified Subcategories</a>
                                </li>                                
                            <?php endif; ?>                            
                        </ul>
                    </li>
