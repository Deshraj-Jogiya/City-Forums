...
<div class="row">
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open('adcat_controller/add_category_post'); ?>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>update-ad-category/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
