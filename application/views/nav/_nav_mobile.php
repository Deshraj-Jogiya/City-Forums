            ...
            <div class="col-sm-12 mobile-nav-buttons">
                <?php if ($this->auth_check) :
                    ...
                    <?php if (check_user_permission('add_classified_ad')): ?>
                        <a class="btn btn-custom btn-mobile-nav btn-mobile-nav-add close-menu-click btn_open_login_modal btn_post_an_ad_classified" href="<?php echo admin_url().'add-new-ad'; ?>"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Place an ad</a>
                    <?php endif; ?>
                <?php else:
