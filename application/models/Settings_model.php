...
class Settings_model extends CI_Model
{
    ...
    public function update_route_settings()
    {
        $data = array(
            ...
            'classified_ad' => $this->input->post('classified', true),
            'adcategory' => $this->input->post('adcategory', true),
    ...
    public function update_preferences($form)
    {
        if ($form == 'general') {
            ...
            $data = array(
                ...
                'redirect_rss_posts_to_original' => $this->input->post('redirect_rss_posts_to_original', true),
            ...
            $data = array(
                'auto_post_deletion' => $this->input->post('auto_post_deletion', true),
                'auto_post_deletion_days' => $this->input->post('auto_post_deletion_days', true),
                'auto_post_deletion_delete_all' => $this->input->post('auto_post_deletion_delete_all', true)
            );
        }
        if (!empty($data)) {
            $this->db->where('id', 1);
    ...
    public function update_allowed_file_extensions()
    {
        $ext_array = @explode(',', $this->input->post('allowed_file_extensions', true));
        if (!empty($ext_array)) {
