...
$route['vr-switch-mode']['POST'] = 'home_controller/switch_mode';
...
$route['add-to-newsletter']['POST'] = 'ajax_controller/add_to_newsletter';
$route['close-newsletter-popup']['POST'] = 'ajax_controller/close_newsletter_popup';
...
$route["vr-run-internal-cron"]['POST']  = "ajax_controller/run_internal_cron";
...
//cLASSIFIED ADS
$route['classified-ads'] = 'home_controller/classifieds';
$route[$routes->adcategory . '/(:any)']['GET'] = 'home_controller/adcategory/$1';
$route[$routes->classified_ad . '/(:any)']['GET'] = 'home_controller/ad_details/$1';
$route['ad-comment-add']['POST'] = 'home_controller/add_comment_on_classified_ad';
$route['ad-contact-seller']['POST'] = 'home_controller/contact_seller_of_ad';
$route['my-listings']['GET'] = 'home_controller/get_all_my_listing';
$route['favourites']['GET'] = 'home_controller/get_all_my_favourite_listings';
$route['inquiries']['GET'] = 'home_controller/get_all_inquiries';
//$route['adcategory/(:any)']['GET'] = 'home_controller/adcategory/$1';
/*
*-------------------------------------------------------------------------------------------------
* ADMIN ROUTES
*-------------------------------------------------------------------------------------------------
...
//classified ads
$route[$routes->admin . "/add-new-ad"] = 'ad_controller/add_new_ad';
$route[$routes->admin . "/ads"] = 'ad_controller/ads';
$route[$routes->admin . "/ad-categories"] = 'adcat_controller/categories';
$route[$routes->admin . "/ad-subcategories"] = 'adcat_controller/subcategories';
$route[$routes->admin . "/update-ad-category/(:num)"] = 'adcat_controller/update_category/$1';
$route[$routes->admin . "/update-ad-subcategory/(:num)"] = 'adcat_controller/update_subcategory/$1';
$route[$routes->admin . "/update-ad/(:num)"] = 'ad_controller/update_post/$1';
...
//newsletter
$route[$routes->admin . "/newsletter"] = 'admin_controller/newsletter';
//comments
...
$route[$routes->admin . "/download-database-backup"] = 'admin_controller/download_database_backup';
